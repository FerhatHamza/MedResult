...
const translations = {
    fr: {
        ...
        step_2: "Présentez-vous au bureau DRH.",
        step_3: "Copie de la carte nationale d’identité.",
        step_4: "Acte de naissance original.",
        step_5: "Copie de l’attestation justifiant la situation vis-à-vis du service national.",
        step_6: "Certificat de situation familiale, le cas échéant.",
        step_7: "Attestation de travail justifiant l’expérience professionnelle acquise.",
        step_8: "Extrait du casier judiciaire (bulletin n° 3) en cours de validité.",
        step_9: "Certificat médical général et pulmonaire.",
        step_10: "Deux (02) photos d’identité.",
    ...
    en: {
        ...
        step_3: "Copy of the national identity card.",
        step_4: "Original birth certificate.",
        step_5: "Copy of the certificate proving the status with regard to national service.",
        step_6: "Family status certificate, where applicable.",
        step_7: "Work certificate proving the acquired professional experience.",
        step_8: "Extract from the criminal record (document No. 3), valid.",
        step_9: "General and chest medical certificate.",
        step_10: "Two (02) passport-size photographs.",
